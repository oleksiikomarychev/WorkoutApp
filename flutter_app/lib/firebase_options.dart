...
/// ```
///
/// IMPORTANT: To generate this file with your Firebase project configuration, run:
/// ```
/// flutterfire configure
/// ```
/// This will create platform-specific configurations for your app.
/// 
/// For local development with Firebase Auth Emulator:
/// - Set FIREBASE_AUTH_EMULATOR_HOST in your backend .env
/// - Optionally configure emulator in AuthService.useAuthEmulator()
class DefaultFirebaseOptions {
  ...
  // TODO: Run `flutterfire configure` to generate these platform-specific options
