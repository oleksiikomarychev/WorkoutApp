# Расчет true_1rm: если значение уже задано, используем его.
# Иначе, если известно rep_max (количество повторений с max_weight),
# рассчитываем по формуле Эпли, которая аппроксимирует 1ПМ для малого
# числа повторений (<=10).
