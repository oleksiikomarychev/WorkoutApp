...
STATE_COMPLETION_PROMPT_TEMPLATE: str = dedent(
    ...
    - Если пользователь пишет, что готов доверить выбор какого-либо параметра ассистенту, считай, что соответствующее требование СЧИТАЕТСЯ ВЫПОЛНЕННЫМ.
    ...
    - Если в диалоге уже есть фразы, явно указывающие на отсутствие ограничений по оборудованию
      ...
      предпочитаемое оборудование уже выполнено и НЕ предлагай задавать дополнительные вопросы
      по оборудованию.
