...
from .routers import workouts, exercises, user_max, calendar_plan_instances, rpe, workout_sessions
...
if os.getenv("ENABLE_EXERCISES_ROUTER", "false").lower() in ("1", "true", "yes", "on"):
    app.include_router(exercises.router, prefix="/api/v1/exercises", tags=["Exercises (monolith)"])
