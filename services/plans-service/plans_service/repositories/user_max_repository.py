...
from ..schemas.user_max import UserMaxCreate, UserMaxUpdate, UserMaxResponse
...
class UserMaxRepository:
    ...
    def get_user_maxes_by_user(
        ...
        return self.db.query(UserMax).filter(UserMax.user_id == user_id).offset(skip).limit(limit).all()
