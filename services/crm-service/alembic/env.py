...
try:
    from crm_service.database import DATABASE_URL, Base  # type: ignore
except Exception:
    Base = None
...
# Resolve URL: prefer env CRM_DATABASE_URL, then alembic.ini
DB_URL = os.getenv("CRM_DATABASE_URL") or DATABASE_URL or config.get_main_option("sqlalchemy.url")
if DB_URL:
